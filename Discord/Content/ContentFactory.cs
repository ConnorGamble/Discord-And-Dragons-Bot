...
namespace DiscordAndDragons.Discord
{
    public class ContentFactory
    {
        ...
        public string PickCustomContent(RollInformation rollInformation, List<string> contentList)
        {
        ...
        public List<string> GetContentList(RollType rollType)
        {
            switch (rollType)
            {
        ...
        public string DefaultContent(RollInformation rollInformation)
        {
